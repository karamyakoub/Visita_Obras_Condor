...
public class Estados_Cidades extends SQLiteOpenHelper {
    private Context context;
    private static final String db_name =  "DB";
    private static final int db_version = 1;

    public Estados_Cidades(@Nullable Context context){
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(context.getString(R.string.sql_uf_table_create));
        db.execSQL(context.getString(R.string.sql_cidade_table_create));
        db.execSQL("INSERT INTO estado (id, nome, uf) VALUES\n" +
                "(1, 'Acre', 'AC'),\n" +
                "(2, 'Alagoas', 'AL'),\n" +
                "(3, 'Amazonas', 'AM'),\n" +
                "(4, 'Amapá', 'AP'),\n" +
                ...
                "(26, 'São Paulo', 'SP'),\n" +
                "(27, 'Tocantins', 'TO');");
        db.execSQL("INSERT INTO cidade (id, nome, estado) VALUES\n" +
                "(1, 'Afonso Cláudio', 8),\n" +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL(context.getString(R.string.sql_uf_table_drop));
        db.execSQL(context.getString(R.string.sql_cidade_table_drop));
        onCreate(db);
    }
